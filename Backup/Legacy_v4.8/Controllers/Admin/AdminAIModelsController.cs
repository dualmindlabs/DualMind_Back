...
{
    [RoutePrefix("api/admin/models")]
    public class AdminAIModelsController : ApiController
    {
        ...
        [HttpPost]
        [Route("")]
        public async Task<IHttpActionResult> Create([FromBody] AIModelCreateRequest request)
        {
            try
            {
        ...
        [HttpPut]
        [Route("{id:guid}")]
        public async Task<IHttpActionResult> Update(Guid id, [FromBody] AIModelUpdateRequest request)
        {
            try
            {
        ...
        [HttpGet]
        [Route("search")]
        public async Task<IHttpActionResult> Search(string name = null, string provider = null, string status = null, int page = 1, int limit = 200)
        {
            try
            {
                if (page < 1) page = 1;
        ...
        public async Task<IHttpActionResult> UpdateStatus(Guid id, [FromBody] dynamic request)
        {
            try
            {
