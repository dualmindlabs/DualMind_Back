...
namespace DualMind_Back.Infrastructure.Data
{
    public class SupabaseService
    {
        ...
        public SupabaseService()
        {
            ...
            if (string.IsNullOrWhiteSpace(_serviceKey))
                throw new Exception("Supabase API key missing. Set SUPABASE_SERVICE_KEY (recommended) or SUPABASE_KEY / SUPABASE_ANON_KEY in .env");
