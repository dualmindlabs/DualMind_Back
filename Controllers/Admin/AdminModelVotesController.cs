...
{
    [RoutePrefix("api/admin/votes")]
    public class AdminModelVotesController : ApiController
    {
        ...
        public async Task<IHttpActionResult> GetByModel(Guid modelId, int page = 1, int limit = 200)
        {
            try
            {
                if (page < 1) page = 1;
        ...
        public async Task<IHttpActionResult> GetByComparison(Guid comparisonId, int page = 1, int limit = 200)
        {
            try
            {
                if (page < 1) page = 1;
        ...
        [HttpPost]
        [Route("")]
        public async Task<IHttpActionResult> Create([FromBody] ModelVoteCreateRequest request)
        {
            try
            {
